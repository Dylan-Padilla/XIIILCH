...
institute: <br>February 27, 2026<br>Yale Institute for Biospheric Studies<br>New Haven, Connecticut<br><center>XIII Latin American Congress of Herpetology, Costa Rica</center>
format: 
  revealjs:
    chalkboard: true
    incremental: true
...
<center>
<br><br>
![](imgs/rugged-landscape.png){width=120%}
</center>
...
2. Gene combinations favored under the locally prevailing conditions are not useful in distant environments
...
- Genomic, behavioral, and life history data
- Foraging behaviors: Active foragers, Plastic foragers, and Sit-and-wait foragers
- Reproductive effort: Average clutch size x Average # clutches per year x longevity
...
Sit-and-wait -> active foraging ($\approx64$), succeeded by Sit-and-wait -> plastic foraging ($\approx57$)
...
Plastic foragers do not incur a cost of carrying around additional genetic material
